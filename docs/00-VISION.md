...
that cannot afford it. Lumit's home lane within that scene is the **flow / MVM style** —
...
Lumit is the deep tool built for them: After Effects' compositing model, Vegas' retiming
...
> A flow-style editor records gameplay tonight and publishes tomorrow, using only Lumit:
