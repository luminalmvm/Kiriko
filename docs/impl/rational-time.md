...
Authoritative time in Lumit is rational ([14-ENGINEERING-RULES.md](../14-ENGINEERING-RULES.md)).
...
Cross-timebase conversion functions live in one module (`lumit-core::time::convert`) and
